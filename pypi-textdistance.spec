...
Version  : 4.6.0
Release  : 27
URL      : https://files.pythonhosted.org/packages/74/e5/eca4fb81146a144b64153d7014122318d2b0632c7c15d847cd755db6539c/textdistance-4.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/74/e5/eca4fb81146a144b64153d7014122318d2b0632c7c15d847cd755db6539c/textdistance-4.6.0.tar.gz
...
%prep
%setup -q -n textdistance-4.6.0
cd %{_builddir}/textdistance-4.6.0
pushd ..
cp -a textdistance-4.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695916225
