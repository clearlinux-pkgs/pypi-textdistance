...
Source0  : https://files.pythonhosted.org/packages/58/ae/688cc1596606b4fdeef519daa1a8ddd749bbcae7cd9f7d6cce7ffe858a12/textdistance-4.6.2.tar.gz
...
%prep
%setup -q -n textdistance-4.6.2
cd %{_builddir}/textdistance-4.6.2
pushd ..
cp -a textdistance-4.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713973498
